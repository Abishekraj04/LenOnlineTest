...
public class readExcel {
    public static List<LinkedHashMap<String, String>> getExcelDataAsMap(String excelFileName, String sheetName) throws EncryptedDocumentException, IOException {
        // Create a Workbook
        Workbook wb = WorkbookFactory.create(new File("C:\\Users\\abivp\\IdeaProjects\\Simple\\datas\\"+excelFileName+".xlsx"));
    ...
    public static void main(String[] args) throws EncryptedDocumentException, IOException {
        ...
        List<LinkedHashMap<String, String>> mapDataList = getExcelDataAsMap("Testdata","Sheet1");
